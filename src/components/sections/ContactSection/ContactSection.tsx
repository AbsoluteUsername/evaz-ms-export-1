...
import type { FormConfig, ContactInfo, SectionContent, ContactFormData } from '@/types'
...
export function ContactSection({
  ...
  return (
    ...
    >
      {/* Background - teal accent at bottom to bookend with hero */}
      <div className="absolute inset-0 bg-gradient-to-b from-white via-white to-teal-900/10 dark:from-stone-950 dark:via-stone-950 dark:to-teal-950/30" />
