...
export function ContactForm({
  ...
  if (formState === 'success') {
    return (
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-500 to-emerald-600 p-8 md:p-10 text-white animate-fade-in">
        {/* Decorative elements */}
  ...
  if (formState === 'error') {
    return (
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-500 to-red-600 p-8 md:p-10 text-white animate-fade-in">
        <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl" />
