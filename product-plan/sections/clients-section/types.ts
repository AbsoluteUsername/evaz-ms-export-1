...
/**
 * Props for the main ClientsSection component
 */
export interface ClientsSectionProps {
  /** Section content (clients and statistics) */
...
/**
 * Props for the ClientSlider component
 */
export interface ClientSliderProps {
  ...
  onNext?: () => void
  /** Called when a dot indicator is clicked */
  onDotClick?: (index: number) => void
  /** Called when a client card is clicked */
  onClientClick?: (client: Client) => void
  /** Enable auto-play (optional) */
  autoPlay?: boolean
...
export interface StatCardProps {
  /** Statistic data to display */
  stat: Statistic
  /** Whether to animate the number (default: true) */
  animate?: boolean
...
export interface StatsGridProps {
  ...
  statistics: Statistic[]
  /** Whether to animate numbers on scroll into view */
